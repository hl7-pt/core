...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:ServiceRequest">
      <sch:assert test="count(f:extension[@url = 'http://hl7.pt/fhir/core/StructureDefinition/PatientTransportNeed']) &lt;= 1">extension with URL = 'http://hl7.pt/fhir/core/StructureDefinition/PatientTransportNeed': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:ServiceRequest/f:doNotPerform">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.pt/fhir/core/StructureDefinition/NotPerformReason']) &lt;= 1">extension with URL = 'http://hl7.pt/fhir/core/StructureDefinition/NotPerformReason': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.pt/fhir/core/StructureDefinition/NotPerformDecider']) &lt;= 1">extension with URL = 'http://hl7.pt/fhir/core/StructureDefinition/NotPerformDecider': maximum cardinality of 'extension' is 1</sch:assert>
