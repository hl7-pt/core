...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationDispense">
      <sch:assert test="count(f:extension[@url = 'http://hl7.pt/fhir/core/StructureDefinition/SendLabel']) &lt;= 1">extension with URL = 'http://hl7.pt/fhir/core/StructureDefinition/SendLabel': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/medicationdispense-refillsRemaining']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/medicationdispense-refillsRemaining': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.pt/fhir/core/StructureDefinition/RegulatedAuthorization']) &lt;= 1">extension with URL = 'http://hl7.pt/fhir/core/StructureDefinition/RegulatedAuthorization': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
