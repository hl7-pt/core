...
* dosageInstruction.timing.repeat.boundsPeriod.start -> "ORC-7.4, RXE-1.4"
* dosageInstruction.timing.repeat.boundsPeriod.end -> "ORC-7.5, RXE-1.5"
...
* dosageInstruction.doseAndRate.rateQuantity.value -> "RXO-21, RXE-23"
* dosageInstruction.doseAndRate.rateQuantity.unit -> "RXO-22.2, RXE-24.2"
* dosageInstruction.doseAndRate.rateQuantity.system -> "RXO-22.3, RXE-24.3"
* dosageInstruction.doseAndRate.rateQuantity.code -> "RXO-22.1, RXE-24.1"
