...
Id: HL7v2.4
Source: PT_Medication
* identifier[GLINTT].system -> "RXO-1.3 / RXO-1.6, RXC-2.3, RXE-2.3, RXD-2.3, RXG-4.3, RXA-5.3"
* code.coding[GLINTT].system -> "RXO-1.3 / RXO-1.6, RXC-2.3, RXE-2.3, RXD-2.3, RXG-4.3, RXA-5.3"
* code.coding[GLINTT].code -> "RXO-1.1 / RXO-1.4, RXC-2.1, RXE-2.1, RXD-2.1, RXG-4.1, RXA-5.1"
* code.coding[GLINTT].display -> "RXO-1.2 / RXO-1.5, RXC-2.2, RXE-2.2, RXD-2.2, RXG-4.2, RXA-5.2"
// WARNING: The following Mapping may be incomplete since the original PT_Medication
// StructureDefinition was missing the mapping entry for HL7v2.4-Supplementary.
// Please review this and add the following properties as necessary: Target, Title, Description
Mapping: HL7v2.4-Supplementary
Id: HL7v2.4-Supplementary
Source: PT_Medication
* identifier[GLINTT].system -> "RXO-24.3, RXC-7.3, RXE-31.3, RXD-25.3"
* code.coding[GLINTT].system -> "RXO-24.3, RXC-7.3, RXE-31.3, RXD-25.3"
* code.coding[GLINTT].code -> "RXO-24.1, RXC-7.1, RXE-31.1, RXD-25.1"
* code.coding[GLINTT].display -> "RXO-24.2, RXC-7.2, RXE-31.2, RXD-25.2"
* ingredient.item[x].coding.system -> "RXO-24.3, RXC-7.3, RXE-31.3, RXD-25.3"
// WARNING: The following Mapping may be incomplete since the original PT_Medication
// StructureDefinition was missing the mapping entry for HL7v2.x.
// Please review this and add the following properties as necessary: Target, Title, Description
...
Id: HL7v2.x
Source: PT_Medication
* identifier[CHNM].system -> "RXO-1.3 / RXO-1.6, RXC-2.3, RXE-2.3, RXE-37.3, RXD-2.3, RXG-4.3, RXA-5.3"
* identifier[ATC].system -> "RXO-1.3 / RXO-1.6, RXC-2.3, RXE-2.3, RXE-37.3, RXD-2.3, RXG-4.3, RXA-5.3"
* identifier.value -> "RXO-1.1 / RXO-1.4, RXC-2.1, RXE-2.1, RXE-37.1, RXD-2.1, RXG-4.1, RXA-5.1"
* code.coding[CHNM].system -> "RXO-1.3 / RXO-1.6, RXC-2.3, RXE-2.3, RXE-37.3, RXD-2.3, RXG-4.3, RXA-5.3"
* code.coding[CHNM].code -> "RXO-1.1 / RXO-1.4, RXC-2.1, RXE-2.1, RXE-37.1, RXD-2.1, RXG-4.1, RXA-5.1"
* code.coding[CHNM].display -> "RXO-1.2 / RXO-1.5, RXC-2.2, RXE-2.2, RXE-37.2, RXD-2.2, RXG-4.2, RXA-5.2"
* code.coding[ATC].system -> "RXO-1.3 / RXO-1.6, RXC-2.3, RXE-2.3, RXE-37.3, RXD-2.3, RXG-4.3, RXA-5.3"
* code.coding[ATC].code -> "RXO-1.1 / RXO-1.4, RXC-2.1, RXE-2.1, RXE-37.1, RXD-2.1, RXG-4.1, RXA-5.1"
* code.coding[ATC].display -> "RXO-1.2 / RXO-1.5, RXC-2.2, RXE-2.2, RXE-37.2, RXD-2.2, RXG-4.2, RXA-5.2"
* manufacturer.reference -> "Organization/RXD-20, RXG-21, RXA-17"
* form.coding.system -> "RXO-5.3, RXE-6.3, RXD-6.3, RXG-8.3, RXA-8.3"
* form.coding.code -> "RXO-5.1, RXE-6.1, RXD-6.1, RXG-8.1, RXA-8.1"
* form.coding.display -> "RXO-5.2, RXE-6.2, RXD-6.2, RXG-8.2, RXA-8.2"
...
Source: PT_Medication
* identifier[CHNM].system -> "RXO-24.3, RXC-7.3, RXE-31.3, RXD-25.3"
* identifier[ATC].system -> "RXO-24.3, RXC-7.3, RXE-31.3, RXD-25.3"
* identifier.value -> "RXO-24.1, RXC-7.1, RXE-31.1, RXD-25.1"
* code.coding[CHNM].system -> "RXO-24.3, RXC-7.3, RXE-31.3, RXD-25.3"
* code.coding[CHNM].code -> "RXO-24.1, RXC-7.1, RXE-31.1, RXD-25.1"
* code.coding[CHNM].display -> "RXO-24.2, RXC-7.2, RXE-31.2, RXD-25.2"
* code.coding[ATC].system -> "RXO-24.3, RXC-7.3, RXE-31.3, RXD-25.3"
* code.coding[ATC].code -> "RXO-24.1, RXC-7.1, RXE-31.1, RXD-25.1"
* code.coding[ATC].display -> "RXO-24.2, RXC-7.2, RXE-31.2, RXD-25.2"
