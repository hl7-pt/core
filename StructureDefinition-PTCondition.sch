...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Condition">
      <sch:assert test="count(f:extension[@url = 'http://hl7.pt/fhir/core/StructureDefinition/DiagnosisPriority']) &lt;= 1">extension with URL = 'http://hl7.pt/fhir/core/StructureDefinition/DiagnosisPriority': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.pt/fhir/core/StructureDefinition/conditionPersistence']) &lt;= 1">extension with URL = 'http://hl7.pt/fhir/core/StructureDefinition/conditionPersistence': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
