...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Practitioner">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.pt/fhir/core/StructureDefinition/Death']) &lt;= 1">extension with URL = 'http://hl7.pt/fhir/core/StructureDefinition/Death': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Practitioner/f:qualification">
      <sch:assert test="count(f:extension[@url = 'http://hl7.pt/fhir/core/StructureDefinition/Proficiency']) &lt;= 1">extension with URL = 'http://hl7.pt/fhir/core/StructureDefinition/Proficiency': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Practitioner/f:communication">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.pt/fhir/core/StructureDefinition/NativeLanguage']) &lt;= 1">extension with URL = 'http://hl7.pt/fhir/core/StructureDefinition/NativeLanguage': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:text) &lt;= 1">text: maximum cardinality of 'text' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
