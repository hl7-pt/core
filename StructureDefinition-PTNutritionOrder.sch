...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  -->
  <sch:pattern>
    <sch:title>f:NutritionOrder/f:foodPreferenceModifier</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:NutritionOrder/f:foodPreferenceModifier/f:coding</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:NutritionOrder/f:oralDiet/f:type/f:coding</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:NutritionOrder/f:supplement/f:type/f:coding</sch:title>
