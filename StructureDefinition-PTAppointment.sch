...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Appointment">
      <sch:assert test="count(f:extension[@url = 'http://hl7.pt/fhir/core/StructureDefinition/ExtraAppointment']) &lt;= 1">extension with URL = 'http://hl7.pt/fhir/core/StructureDefinition/ExtraAppointment': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
